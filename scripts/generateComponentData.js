...
var paths = {
    examples: path.join(__dirname, '../src', 'docs', 'examples'), //path to docs
    components: path.join(__dirname, '../src', 'components'), //path to source files
    output: path.join(__dirname, '../config', 'componentData.js') //where metadata files will go
};
